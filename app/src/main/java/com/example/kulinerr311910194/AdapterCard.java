...
public class AdapterCard extends RecyclerView.Adapter<AdapterCard.CardViewHolder> {
    ...
    private ArrayList<com.example.kulinerr311910194.ModelKuliner> dataKuliner;

    public AdapterCard(ArrayList<com.example.kulinerr311910194.ModelKuliner> dataKuliner) {
    ...
    public void onBindViewHolder(@NonNull CardViewHolder holder, int position) {
        ...
        com.example.kulinerr311910194.ModelKuliner kulinermodel = dataKuliner.get(position);
