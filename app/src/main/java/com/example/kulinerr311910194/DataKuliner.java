...
public class DataKuliner {
        ...
        public static ArrayList<com.example.kulinerr311910194.ModelKuliner> ambilDataKuliner() {
                ArrayList<com.example.kulinerr311910194.ModelKuliner> dataKuliner = new ArrayList<>();
                for (String[] varData : data) {
                        com.example.kulinerr311910194.ModelKuliner model = new com.example.kulinerr311910194.ModelKuliner();
